...
<template>
  ...
  >
    <CardBox 
      class="w-full max-w-md mx-4 transform transition-transform duration-300 scale-100"
    ...
    >
      ...
      <div class="space-y-3 mb-6 max-h-64 overflow-y-auto">
        <div 
          ...
          :key="role.name"
          @click="!isLoading && selectRole(role.name)"
          class="p-4 border rounded-lg cursor-pointer transition-all duration-200 flex items-start group"
          :class="{
          ...
          <div class="flex-1 min-w-0">
            <div class="flex items-center justify-between mb-1">
              <span class="font-semibold text-gray-900 dark:text-white truncate">
                {{ role.name }}
                <span 
                  v-if="role.name === currentActiveRole" 
              ...
              <BaseIcon 
                ...
                :path="mdiCheckCircle" 
                class="text-blue-600 dark:text-blue-300 ml-2 flex-shrink-0" 
                size="20" 
              />
            </div>
      ...
      <div class="flex justify-between items-center pt-4 border-t dark:border-gray-700">
        ...
        <div class="flex space-x-2">
          ...
          <BaseButton 
            color="info" 
            :label="isLoading ? 'Cambiando...' : 'Confirmar'" 
